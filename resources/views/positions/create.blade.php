        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h2 class="mt-2 text-2xl font-bold text-slate-950">Tambah Jabatan</h2>
                    <p class="mt-2 max-w-2xl text-sm text-slate-500">Tambahkan jabatan yang digunakan untuk posisi anggota dalam organisasi.</p>
                </div>
