...
@section('content')
    <div class="w-full space-y-6">
        <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <form method="POST" action="{{ route('agenda-schedules.activities.store', $agendaSchedule) }}" class="mt-6 border-t border-slate-200 pt-6" x-data="{ submitting: false }" x-on:submit="submitting = true">
                @csrf
                ...
                <div class="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                    ...
                    <x-ui.submit-button loading-text="Menyimpan...">Buat Kegiatan</x-ui.submit-button>
                </div>
            </form>
        </div>
    </div>
