<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-5 space-y-5" x-data="{ submitting: false }" x-on:submit="submitting = true">
        @csrf
        @method('patch')
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <x-ui.submit-button size="lg" loading-text="Menyimpan...">Simpan Perubahan</x-ui.submit-button>
