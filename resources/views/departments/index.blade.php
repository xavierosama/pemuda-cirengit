                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-4 text-right text-sm font-semibold">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('departments.show', $department) }}" class="rounded-md px-2.5 py-1.5 text-slate-700 transition hover:bg-slate-100">Detail</a>
                                        <a href="{{ route('departments.edit', $department) }}" class="rounded-md px-2.5 py-1.5 text-emerald-700 transition hover:bg-emerald-50">Edit</a>
                                        <form method="POST" action="{{ route('departments.destroy', $department) }}" onsubmit="return confirm('Hapus data bidang ini?')">
                                            @csrf
                                            @method('DELETE')
